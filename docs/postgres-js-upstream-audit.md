...
| [#728](https://github.com/porsager/postgres/issues/728) | PostgreSQL temporal infinity becomes an invalid `Date`. | The Temporal-only boundary rejects infinity explicitly and never constructs or returns JavaScript `Date`. |
