...
export function runInit(opts: InitOptions): void {
  ...
  if (schemaProvider === "pgschema") {
    ...
    log("  4. Edit schema.sql, then develop:  sqlx-js db dev --strict-inference");
    log("  5. Verify desired schema and SQL:  sqlx-js db verify --strict-inference");
    log("  6. Review target changes:  sqlx-js db plan");
  } else {
